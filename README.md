...
Runtime integrators may opt into [source-free OpenTelemetry-compatible observability](docs/OBSERVABILITY.md). It is bounded and failure-isolated, and never replaces the local hash-chained audit.
