import type { CopilotUiContract, EdgeLaunchConfig } from "../browser/index.js";
...
export const BROWSER_CONFIG_VERSION = "cba-browser-config/1" as const;
...
export interface BrowserFileConfig {
  ...
  readonly waits?: Partial<EdgeLaunchConfig["waits"]>;
...
export interface LoadedRuntimeConfiguration {
  ...
  readonly browser?: EdgeLaunchConfig & { readonly edgeExecutable: string };
  readonly hashes: {
