...
const verifier = new URL("./verify.mjs", import.meta.url);
const verification = spawnSync(process.execPath, [verifier.pathname, candidate, "--require-signature", "--trusted-key-id", trustedKeyId], { encoding: "utf8" });
