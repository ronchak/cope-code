...
transport-level fixture assertions. Model responses should use `cba-agent/1`
and omit task, turn, message, and operation IDs; the harness derives those
values. Historical `cba/1` responses remain accepted as migration fixtures.
